    ...
    <section className="greeting">
      ...
      {/* <svg id="visual" preserveAspectRatio="none" viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg"
        ...
        <g transform="translate(-7, 541)">
          <path id="blobb4"
            d="M0 -324C25.4 -303.1 50.7 -282.2 71.2 -265.6C91.6 -249 107.1 -236.7 136 -235.6C164.9 -234.4 207.1 -244.3 229.1 -229.1C251.1 -213.9 252.9 -173.7 244.2 -141C235.5 -108.3 216.4 -83.3 228 -61.1C239.5 -38.9 281.8 -19.4 324 0L0 0Z"
            fill="#e9ecef"></path>
        </g>
        <g transform="translate(964, -8)">
          <path id="blobt4"
